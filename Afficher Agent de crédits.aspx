<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Afficher Agent de crédits.aspx.cs" Inherits="Afficher_Agent_de_crédits" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row"><div class="col-lg-9 main-chart" style="text-align: center">
            <!--CUSTOM CHART START -->
            <div class="style7">
                <strong>Afficher&nbsp; Agent de crédits<br />
                </strong></div>
            <!--custom chart end-->
            <!-- /row -->
            <div class="row">
              ...
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      ...
                      <strong><span class="style9"><span class="style10">RECHERCHE AGENCE PAR ID :</span><span 
                          ...
                          ID="TextBox8" runat="server" Width="251px"></asp:TextBox>
                      <br />
                      <br />
                      <br />
                      IDENTIFIANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:TextBox 
