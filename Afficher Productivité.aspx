<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Afficher Productivité.aspx.cs" Inherits="Afficher_Productivité" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row"><div class="col-lg-9 main-chart" style="text-align: center">
            <!--CUSTOM CHART START -->
            <div class="style7">
                <strong>Afficher&nbsp; Productivité<br />
                </strong></div>
            <!--custom chart end-->
            <!-- /row -->
            <div class="row">
            ...
            <div class="border-head">
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      ...
                      <strong><span class="style9"><span class="style10">RECHERCHE PRODUCTIVITE PAR ID 
                      :</span><span 
                      ...
                      <br />
                      <br />
                      <strong><span class="style8">Jours&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; </span></strong>
                      <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      <strong><span class="style8">Mois&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></strong>
                      ...
                      <asp:Button ID="Button1" runat="server" Height="52px" Text="AFFICHER" 
                          Width="257px" onclick="Button1_Click" />
                  </asp:Panel>
