<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Afficher Agence.aspx.cs" Inherits="Afficher_Agence" %>
  ...
  *
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row"><div class="col-lg-9 main-chart" style="text-align: center">
            <!--CUSTOM CHART START -->
            <div class="style7">
                <strong>Afficher&nbsp; Agence<br />
                </strong></div>
            <!--custom chart end-->
            <!-- /row -->
            <div class="row">
            ...
            <div class="border-head">
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      style="text-align: center; margin-left: 261px" Width="881px">
                      <strong><span class="style9"><span class="style10">RECHERCHE AGENCE PAR ID :</span><span 
                          class="style8"><em> </em></span></span><span class="style8">&nbsp;<asp:TextBox 
                          ID="TextBox6" runat="server" Width="251px"></asp:TextBox>
                      <br />
                      <br />
                      <br />
                      <br />
                      IDENTFIENT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></strong>&nbsp;<asp:TextBox 
                          ID="TextBox1" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      <strong><span class="style8">VILLE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; </span></strong>
                      <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      <strong><span class="style8">TELEPHONE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></strong>
                      <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      <strong><span class="style8">E-MAIL</span></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      <strong><span class="style8">CHIFFRE D&#39;AFFAIRE</span></strong><asp:TextBox 
                          ID="TextBox5" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      <br />
                      <asp:Button ID="Button1" runat="server" Height="52px" Text="AFFICHER" 
                          Width="257px" onclick="Button1_Click1" />
                  </asp:Panel>
                  <span class="style7"><strong><em>
                  <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;<br />
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-12">&nbsp;&nbsp;<div class="col-lg-9 main-chart" 
                          style="text-align: center; top: -75px; left: 0px; height: 345px;">
            <!--CUSTOM CHART START -->
            <div class="border-head">
