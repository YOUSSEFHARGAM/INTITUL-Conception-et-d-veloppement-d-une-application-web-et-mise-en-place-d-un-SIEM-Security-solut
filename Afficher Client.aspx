<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Afficher Client.aspx.cs" Inherits="Afficher_Client" %>
              ...
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      ...
                      <strong><span class="style9"><span class="style10">RECHERCHE AGENCE PAR ID :</span><span 
                          ...
                          ID="TextBox" runat="server" Width="251px"></asp:TextBox>
                      <br />
                      <br />
                      <br />
                      </span>IDENTIFIANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>&nbsp;<asp:TextBox 
                      ...
                      <br />
                      <br />
                      <strong>MONTANT CREDITS&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox 
