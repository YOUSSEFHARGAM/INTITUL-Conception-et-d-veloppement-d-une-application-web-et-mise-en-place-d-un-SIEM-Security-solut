<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gestion Client.aspx.cs" Inherits="Gestion_Client" %>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub" style="">
              <li><a href="file:///C:/Users/JO-GHOST/Desktop/PROJECT/Acceuil%20Utilisateur.html">Retour Acceuil</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <ul class="sub">
        ...
        <div class="row">
          <div class="col-lg-9 main-chart" style="text-align: center">
            ...
            <div class="border-head">
              <div class="style2">&nbsp; <span class="style7"><strong><em>&nbsp; GESTION DES 
                  CLIENTS
                  <br />
                  <br />
                  </em></strong></span>
                  ...
                  <asp:HyperLink ID="HyperLink1" runat="server" 
                      NavigateUrl="http://localhost:58671/WebApplicationIMF/Ajouter%20client.aspx">AJOUTER</asp:HyperLink>
&nbsp;
                  <img alt="" class="style9" src="adduser_1103.png" /><br />
                  <br />
                  <br />
                  &nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink2" runat="server" 
                      NavigateUrl="http://localhost:58671/WebApplicationIMF/Modifier%20client.aspx">MODIFIER</asp:HyperLink>
                  &nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink3" runat="server" 
                      NavigateUrl="http://localhost:58671/WebApplicationIMF/Supprimer%20Client.aspx">SUPPRIMER</asp:HyperLink>
                  &nbsp;
                  <img alt="" class="style10" src="user-delete_114455.png" /><br />
                  <br />
                  <br />
&nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink4" runat="server" 
                      NavigateUrl="http://localhost:58671/WebApplicationIMF/Afficher%20Client.aspx">CONSULETR</asp:HyperLink>
                  &nbsp;&nbsp;&nbsp;
                  <img alt="" class="style8" src="action-people-user-eco_108546.png" /><br />
                </div>
            </div>
            <!--custom chart end-->
            <!-- /row -->
