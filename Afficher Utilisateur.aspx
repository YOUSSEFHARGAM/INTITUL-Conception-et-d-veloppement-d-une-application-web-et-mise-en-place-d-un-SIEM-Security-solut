<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Afficher Utilisateur.aspx.cs" Inherits="Afficher_Utilisateur" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row"><div class="col-lg-9 main-chart" style="text-align: center">
            <!--CUSTOM CHART START -->
            <div class="style7">
                <strong>Afficher </strong>Utilisateur<strong><br />
                </strong></div>
            <!--custom chart end-->
            <!-- /row -->
            <div class="row">
              ...
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      ...
                      <strong><span class="style9"><span class="style10">RECHERCHE AGENCE PAR ID :</span><span 
                          ...
                          ID="TextBox9" runat="server" Width="251px"></asp:TextBox>
                      <br />
                      <br />
                      <br />
                      <br />
                      IDENTIFIANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      LOGIN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
