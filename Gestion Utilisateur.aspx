<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gestion Utilisateur.aspx.cs" Inherits="Gestion_Utilisateur" %>
  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h4 class="centered">ADMINISTRATEUR</h4>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub" style="">
              <li><a href="http://localhost:58671/WebApplicationIMF/Acceuil%20Administrateur.aspx">Retour Acceuil</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <ul class="sub">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-9 main-chart" style="text-align: center">
            <!--CUSTOM CHART START -->
            <div class="border-head">
                <span class="style7"><strong>GESTION UTILISATEUR<br />
                <br />
                <br />
                </strong></span><strong>
                <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink1" runat="server" CssClass="style3" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Ajouter%20Utilisateur.aspx">AJOUTER</asp:HyperLink>
                <span class="style1"><span class="style2">&nbsp;
                  <img alt="" class="style7" src="—Pngtree—add%20vector%20icon_3791307.png" /></span><br 
                    class="style2" />
                  <br class="style2" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink2" runat="server" CssClass="style2" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Modifier%20Utilisateur.aspx">MODIFIER</asp:HyperLink>
                  &nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink3" runat="server" CssClass="style2" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Supprimer%20Utilisateur.aspx">SUPPRIMER</asp:HyperLink>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink4" runat="server" CssClass="style2" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Afficher%20Utilisateur.aspx">CONSULETR</asp:HyperLink>
                  </span></strong>
                <img alt="" class="style10" src="—Pngtree—vector%20search%20icon_3783210.png" /></div>
            <!--custom chart end-->
            <!-- /row -->
            <div class="row">
              <div class="col-md-12">
  ...
  <script type="application/javascript" style="">
    ...
    <pingendo onclick="window.open('https://pingendo.com/', '_blank')" style="cursor:pointer;position: fixed;bottom: 20px;right:20px;padding:4px;background-color: #00b0eb;border-radius: 8px; width:220px;display:flex;flex-direction:row;align-items:center;justify-content:center;font-size:14px;color:white">&nbsp;&nbsp;</pingendo>
