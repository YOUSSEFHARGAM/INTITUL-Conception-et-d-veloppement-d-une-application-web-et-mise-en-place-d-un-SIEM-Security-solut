<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ajouter Agence.aspx.cs" Inherits="Ajouter_Agence" %>
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span> Acceuil Utilisateur</span></a><ul class="sub" style="">
              <li><a href="http://localhost:58268/WebApplicationIMF/Acceuil%20Utilisateur.aspx">Retour Acceuil</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <ul class="sub">
            ...
            <div class="border-head">
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      ...
                      <strong><span class="style8">IDENTFIENT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></strong>&nbsp;<asp:TextBox 
                      ...
                      <br />
                      <br />
                      <asp:Button ID="Button1" runat="server" Height="52px" Text="AJOUTER" 
