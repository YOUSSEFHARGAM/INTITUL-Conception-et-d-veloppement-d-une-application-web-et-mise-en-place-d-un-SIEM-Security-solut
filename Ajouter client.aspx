<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ajouter client.aspx.cs" Inherits="Ajouter_client" %>
        ...
        <div class="row">
          <div class="col-lg-9 main-chart" style="text-align: center">
            ...
            <div class="border-head">
              <div class="style2">
                  <strong><em><span class="style3">AJOUTER CLIENT<br />
                  </span></em></strong>
                  <br />
                  <strong>IDENTIFIANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <br />
                  <br />
                  <strong>MONTANT CREDITS&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Height="40px" Text="AJOUTER" 
                      Width="188px" onclick="Button1_Click" />
                  <br />
                </div>
            </div>
            <!--custom chart end-->
