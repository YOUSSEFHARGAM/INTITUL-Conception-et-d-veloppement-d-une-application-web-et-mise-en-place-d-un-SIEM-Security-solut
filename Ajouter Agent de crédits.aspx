<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ajouter Agent de crédits.aspx.cs" Inherits="Ajouter_Agent_de_crédits" %>
        ...
        <div class="row">
          <div class="col-lg-9 main-chart" style="text-align: center">
            ...
            <div class="border-head">
              <div class="style2">
                  <strong><span class="style3">Afficher </span><em><span class="style3">AGENT DE CREDITS 
                  <br />
                  </span></em></strong>
                  <br />
                  <strong>IDENTIFIANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
