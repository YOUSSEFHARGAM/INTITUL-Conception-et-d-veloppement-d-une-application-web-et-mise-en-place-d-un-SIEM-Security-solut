<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ajouter Productivité.aspx.cs" Inherits="Ajouter_Productivité" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row"><div class="col-lg-9 main-chart" style="text-align: center">
            <!--CUSTOM CHART START -->
            <div class="style7">
                <strong>Ajouter Productivité<br />
                </strong></div>
            <!--custom chart end-->
            <!-- /row -->
            <div class="row">
            ...
            <div class="border-head">
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      ...
                      <strong><span class="style8">IDENTIFIANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </span></strong>&nbsp;<asp:TextBox 
                          ID="TextBox1" runat="server"></asp:TextBox>
                      <br />
                      <br />
                      <strong><span class="style8">JOUR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; </span></strong>
                      ...
                      <br />
                      <br />
                      <strong><span class="style8">ANNEE</span></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
