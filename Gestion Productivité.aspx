<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gestion Productivité.aspx.cs" Inherits="Gestion_Productivité" %>
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span> Gestion Productivité </span>
            </a>
            <ul class="sub" style="">
        ...
        <div class="row">
          <div class="col-lg-9 main-chart" style="text-align: center">
            ...
            <div class="border-head">
                <span class="style7"><strong>GESTION DE LA PRODUCTIVITE<br />
                <br />
                <br />
                </strong></span><strong>
                <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink1" runat="server" CssClass="style3" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Ajouter%20Productivit%C3%A9.aspx">AJOUTER</asp:HyperLink>
                <span class="style1"><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;
                <img alt="" class="style5" src="—Pngtree—add%20vector%20icon_3791307.png" /></span><br 
                    class="style2" />
                  <br class="style2" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink2" runat="server" CssClass="style2" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Modifier%20Productivit%C3%A9.aspx">MODIFIER</asp:HyperLink>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                  <asp:HyperLink ID="HyperLink3" runat="server" CssClass="style2" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Suppprimer%20Productivit%C3%A9.aspx">SUPPRIMER</asp:HyperLink>
                  &nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                  <asp:HyperLink ID="HyperLink4" runat="server" CssClass="style2" 
                    NavigateUrl="http://localhost:58671/WebApplicationIMF/Afficher%20Productivit%C3%A9.aspx">CONSULETR</asp:HyperLink>
                  </span></strong>
                <img alt="" class="style6" src="—Pngtree—vector%20search%20icon_3783210.png" /></div>
            <!--custom chart end-->
            <!-- /row -->
            <div class="row">
              <div class="col-md-12">
