<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Acceuil Utilisateur.aspx.cs" Inherits="Acceuil_Utilisateur" %>
    ...
    <header class="header black-bg">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="http://localhost:58671/WebApplicationIMF/LoginU.aspx">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered">ALI BEN ABID</h5>
		   <h4 class="centered">UTILISATEUR</h4>
            ...
            <ul class="sub" style="">
              <li><a href="http://localhost:58671/WebApplicationIMF/Gestion%20Agence.aspx">Gestion Agence</a></li>
              <li><a href="http://localhost:58671/WebApplicationIMF/Gestion%20Client.aspx">Gstion Client</a></li>
              <li><a href="hhttp://localhost:58671/WebApplicationIMF/Gestion%20Agent%20de%20cr%C3%A9dits.aspx">Gestion Agent de Credits</a></li>
              <li><a href="http://localhost:58671/WebApplicationIMF/Gestion%20Productivit%C3%A9.aspx">Gestion Productivité</a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a target="_blank" href="http://localhost:8000/fr-FR/app/launcher/home">START SPLUNK MANAGER</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
              <i class="fa fa-cogs"></i>
              <span> OUTILS TEST PENETRATION </span>
            </a>
            <ul class="sub" style="">
              <li><a href="file:///C:/Users/JO-GHOST/Desktop/PROJECT/Wireshark.html">WIRESHARK</a></li>
              <li><a href="file:///C:/Users/JO-GHOST/Desktop/PROJECT/Metasploit.html">METASPLOIT</a></li>
              <li><a href="file:///C:/Users/JO-GHOST/Desktop/PROJECT/Moniteur%20r%C3%A9seau%20PRTG.html">PRTG Network monitor</a></li>
              <li><a href="file:///C:/Users/JO-GHOST/Desktop/PROJECT/Snort.html">Snort</a></li>
              <li><a href="file:///C:/Users/JO-GHOST/Desktop/PROJECT/Acunetix.html">ACUNETIX</a></li>
            </ul>
          </li>
