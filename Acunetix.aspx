<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copie de Modifier Agence.aspx.cs" Inherits="Modifier_Agence" %>
            ...
            <div class="border-head">
              <div class="style2">
                  <asp:Panel ID="Panel3" runat="server" Height="150px" 
                      ...
                      <br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></strong>&nbsp;<br />
                      <strong><span class="style8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; </span></strong>
                      <br />
                      <br />
                      <strong><span class="style8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:Button ID="Button1" runat="server" Height="52px" Text="Démarrer ACUNETIX" 
                          Width="257px" />
                      </span></strong>
                      <br />
                      <br />
